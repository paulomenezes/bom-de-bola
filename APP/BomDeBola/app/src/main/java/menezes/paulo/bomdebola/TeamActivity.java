...
import menezes.paulo.bomdebola.fragments.team.FragmentCast;
import menezes.paulo.bomdebola.fragments.team.FragmentGeral;
import menezes.paulo.bomdebola.fragments.team.FragmentTable;
...
public class TeamActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        }).execute(URLs.API_TEAM_READ + mTeam);
    ...
    private void setupViewPager(ViewPager viewPager) {
        Bundle b = new Bundle();
        b.putString("team", mTeam);
        b.putString("championship", mChampionship);

        Fragment f = new FragmentGeral();
        f.setArguments(b);

        Fragment f2 = new FragmentTable();
        f2.setArguments(b);

        Adapter adapter = new Adapter(getSupportFragmentManager());
        adapter.addFragment(f, "Geral");
        adapter.addFragment(new FragmentNews(), "Notícias");
        adapter.addFragment(new FragmentGames(), "Jogos");
        //adapter.addFragment(f2, "Tabela");
        adapter.addFragment(new FragmentCast(), "Equipe");
