 ...
 */
public class AdapterFragmentManagerChampionship extends RecyclerView.Adapter<AdapterFragmentManagerChampionship.ViewHolder> {
    ...
    public AdapterFragmentManagerChampionship(Context context, List<JSONObject> items, RecyclerView recyclerView) {
